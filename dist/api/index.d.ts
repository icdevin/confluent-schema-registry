...
/// <reference types="mappersmith/typings/middleware/retry" />
...
declare const _default: ({ auth, clientId: userClientId, host, retry, agent, }: SchemaRegistryAPIClientArgs) => SchemaRegistryAPIClient;
